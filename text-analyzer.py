...
word=text.split()
print(f"We have Found {len(word)} words in your text.")
...
word.reverse()
inverted_text="".join(word)
print(f"we order your text backwards it will say'{inverted_text}'.")

print("\n")
print("LOOKING FOR THE WORD PYTHON ")

is_python='python' in text
Dic_1={True:"was",False:"was not"}

print(f"The word 'Python' {Dic_1[is_python]} found in the text.")